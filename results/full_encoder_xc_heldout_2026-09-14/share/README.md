# Held-out XC: fully fine-tuned SongMAE-Large
...
Probability Gaussian smoothing: sigma 2 mel bins and 3 frames (15 ms). Threshold 0.09 selected on Powdermill Recordings 2–4, not these XC examples. No other cleanup.
